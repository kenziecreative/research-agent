...
1. **Collect** — Use `/research:process-source` for each URL, PDF, or document relevant to the *current phase only*.
...
- The eight research skills available: `/research:process-source`, `/research:cross-ref`, `/research:check-gaps`, `/research:audit-claims`, `/research:summarize-section`, `/research:start-phase`, `/research:phase-insight`, `/research:progress`
